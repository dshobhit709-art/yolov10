...
- Access the live site at http://localhost:8000.
...
![Deployment Settings](https://user-images.githubusercontent.com/26833433/210150206-9e86dcd7-10af-43e4-9eb2-9518b3799eac.png)

- For detailed deployment guidance, consult the MkDocs documentation at https://www.mkdocs.org/user-guide/deploying-your-docs/.

## Contribute

We cherish the community's input as it drives Ultralytics open-source initiatives. Dive into the Contributing Guide at https://docs.ultralytics.com/help/contributing and share your thoughts via our Survey. A heartfelt thank you to each contributor!
...
For bug reports and feature requests, navigate to GitHub Issues. Engage with peers and the team on Discord for enriching conversations!

## Maintainer

This repository is maintained by Shobhit Dixit, an AI/ML Engineer specializing in scalable machine learning and generative AI solutions. With expertise in Python, PyTorch, and MLOps, Shobhit oversees the technical documentation and deployment pipelines for this project.

Contact: iamshobhit98@gmail.com
