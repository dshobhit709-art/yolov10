...
Shobhit is an AI/ML Engineer with nearly 5 years of experience building scalable machine learning and generative AI solutions across financial services and healthcare analytics environments. He specializes in developing production ML pipelines and real-time inference systems, with expertise in Python, PyTorch, TensorFlow, AWS, LLM applications, RAG architectures, vector databases, and MLOps automation.
