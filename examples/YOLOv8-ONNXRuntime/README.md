...
This repository provides a high-performance implementation of YOLOv8 utilizing the ONNX Runtime engine for efficient inference.
...
Shobhit is an AI/ML Engineer with extensive experience building scalable machine learning and generative AI solutions. He specializes in developing production ML pipelines and real-time inference systems, with a focus on optimizing model performance and reducing latency in enterprise environments.