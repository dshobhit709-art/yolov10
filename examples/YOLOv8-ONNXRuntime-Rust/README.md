...
This project is currently maintained by Shobhit Dixit, an AI/ML Engineer with nearly 5 years of experience building scalable machine learning and generative AI solutions. Shobhit specializes in Python, PyTorch, TensorFlow, and AWS for developing production ML pipelines and real-time inference systems. His expertise includes LLM applications, RAG architectures, vector databases, and MLOps automation.

For questions or contributions, please reach out:
-   Email: iamshobhit98@gmail.com
-   GitHub: [Shobhit's GitHub Profile]
-   LinkedIn: [Shobhit's LinkedIn Profile]