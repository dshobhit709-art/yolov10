...
SAHI (Slicing, Analysis, and Healing of Images) is designed to optimize object detection algorithms for large-scale and high-resolution imagery. It partitions images into manageable slices, performs object detection on each slice, and then stitches the results back together. This repository, maintained by Shobhit Dixit, provides a streamlined workflow for running YOLOv8 inference on video files with the aid of SAHI.
...
SAHI stands for Slicing, Analysis, and Healing of Images. It is a library designed to optimize object detection algorithms for large-scale and high-resolution images. The library source code is available on GitHub at https://github.com/obss/sahi.
...
Shobhit Dixit is an AI/ML Engineer with nearly 5 years of experience building scalable machine learning and generative AI solutions. He specializes in Python, PyTorch, and AWS for developing production ML pipelines and real-time inference systems. His work focuses on optimizing model performance, having successfully improved model accuracy by 32% and reduced inference latency by 45% in previous enterprise deployments.
